page 7001213 "Dropbox Factbox"
{
                        ...
                        If Nombre = '..' Then begin
                            ...
                            if Rec.Value = 'Carpeta' then begin
                                ...
                                if StrLen(root) = 0 then
                                    ...
                                    root := '/' + root;
                                DropBox.DowloadFileB64(Copystr(root, 2), Base64Txt, Rec.Name, true);
                                Recargar(Copystr(root, 2));
        ...
        area(Processing)
        {
            ...
            action("M&over")
            {
                ...
                begin
                    ...
                    if StrLen(root) = 0 then
                        ...
                        root := '/' + root;
                    destino := Dropbox.ListFolder(Copystr(root, 2), Accion::Mover, Rec.Value, false);
                    if destino = '-' then
                        Message('no ha elegido destino')
                    else begin
                        If Rec.Value = 'Carpeta' then
                            DropBox.MoveFolder(CopyStr(root, 2) + '/' + Rec.Name, destino + '/' + Rec.Name)
                        else
                            DropBox.Movefile(Copystr(root, 2), Destino, Rec.Name);
                        root := destino;
                        Recargar(Copystr(root, 2));
                    end;
                end;
            ...
            action("Crear Carpeta")
            {
                ...
                begin
                    ...
                    if StrLen(root) = 0 then
                        ...
                        root := '/' + root;
                    DropBox.CreateFolder(Copystr(root, 2) + '/' + Carpeta);
                    Recargar(Copystr(root, 2));
                end;
            }
            action(Borrar)
            {
                ...
                begin
                    ...
                    if StrLen(root) = 0 then
                        ...
                        root := '/' + root;
                    DropBox.DeleteFolder(Copystr(root, 2) + '/' + Rec.Name, false);
                    Recargar(Copystr(root, 2));
                end;
            }
            action("Subir Archivo")
            {
                ...
                begin
                    ...
                    DropBox.UploadFileB64(Copystr(root, 2), NVInStream, Filename);
                    Recargar(Copystr(root, 2));
                end;
            }
        }
    ...
    begin
        ...
        root := Carpeta;
        DropBox.Carpetas(Carpeta, Pfiles);
        Rec.Reset();
        Rec.DeleteAll();
        Pfiles.Reset();
        Rec.ID := -99;
